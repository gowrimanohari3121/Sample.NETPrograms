'This project was created by Marco M. Abrahan
'You Can Change this depends on whatever you want
Public Class Form1
    ...
    Private Sub btnCE_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCE.Click
        lblDisplay.Text = "0"
        operater_on = False
        operater = ""
    End Sub
